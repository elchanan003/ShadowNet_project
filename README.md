...
מערכת לניהול סוכנים ומשימות של יחידת מודיעין
המערכת עובדת מול מסד נתונים המכיל מידע על סוכנים ומשימות
,ואחראית על יצירת ואיתור סוכנים במאגר, הגדרות של סטטוס הסוכנים  אחראית על יצירת ושיוך המשימות וכן על ניתוח הנתונים ויצירת דוחות
